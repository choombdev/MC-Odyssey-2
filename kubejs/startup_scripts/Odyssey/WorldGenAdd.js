...
onEvent('worldgen.add', event => {
  ...
  event.addOre(ore => {
    ...
    ore.spawnsIn.blacklist = false
    ore.spawnsIn.values =  ['#forge:stone','minecraft:stone','minecraft:andesite','minecraft:diorite','minecraft:granite','minecraft:blackstone','create:limestone','quark:slate','quark:deepslate']
