...
onEvent('recipes', event => {
    ...
    event.recipes.bloodmagic.altar('gobber2:gobber2_globette_end', 'gobber2:gobber2_globette_nether').upgradeLevel(4).altarSyphon(20000).consumptionRate(20).drainRate(20)
    ...
    // Gaia
    event.recipes.bloodmagic.altar('botania:gaia_ingot', 'kubejs:choombium_ingot').upgradeLevel(4).altarSyphon(8500).consumptionRate(15).drainRate(15)
